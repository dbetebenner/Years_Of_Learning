...
## {#title-slide background="images/apples_by_the_bushel.jpg" background-size="cover" background-color="#4f6952"}
...
# Trustworthy AI 🔮 {background-image="images/cfa_logo_full_color.png" background-color="black"}
